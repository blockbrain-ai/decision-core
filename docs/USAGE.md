# Decision Core — Full Usage Guide

> This is the complete reference guide (Personal / Team / Enterprise quick starts, full CLI
> reference, policy packs, trust tiers, MCP/HTTP, org mode). For the short landing page, see
