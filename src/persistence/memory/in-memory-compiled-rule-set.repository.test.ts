...
import { InMemoryCompiledRuleSetRepository } from './in-memory-compiled-rule-set.repository.js';
...
describe('InMemoryCompiledRuleSetRepository', () => {
  let repo: InMemoryCompiledRuleSetRepository;

  beforeEach(() => {
    repo = new InMemoryCompiledRuleSetRepository();
  });
